    ...
    return (
      <div className={styles.collection}>
        <header className={styles.header}>
          ...
          <a href="" className={styles.iconLink} onClick={this.onInfoClick}>
            <svg><use xlinkHref="#icon-info" /></svg>
          </a>
          <a href="" className={styles.iconLink} onClick={this.onRenameClick}>
            <svg><use xlinkHref="#icon-create" /></svg>
          </a>
          <a href="" className={styles.iconLink} onClick={this.onDropClick}>
            <svg><use xlinkHref="#icon-delete" /></svg>
          </a>
          <a href="" className={styles.iconLink}>
            <svg><use xlinkHref="#icon-add" /></svg>
          </a>
          <Popover className="menu" position="bottom" trigger={<svg><use xlinkHref="#icon-visibility" /></svg>}>
        ...
        <Results
          ...
          rpp={filter.limit}
          onPageLoadRequest={this.onPageLoad}
        />
      </div>
    );
  }
